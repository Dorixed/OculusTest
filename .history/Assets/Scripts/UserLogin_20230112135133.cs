...
public class UserLogin : MonoBehaviour, IPointerClickHandler {
    ...
    private void Start() {
        ...
        Debug.Log("loginMessage " + loginMessage);
    ...
    public void OnPointerClick(PointerEventData eventData) {
        ...
        else if(eventData.pointerPress.name == "registButton"){
    ...
    private void OnClickedLoginButton() {
        mysql.OpenSql();
        string loginMsg = "";
        DataSet ds = mysql.Select("usertable", new string[] { "*" }, new string[] { "`" + "account" + "`", "`" + "password" + "`" }, new string[] { "=", "=" }, new string[] { userNameInput.text, passwordInput.text });
        if (ds != null) {
